...
def create_regions(world):
    ...
    world.regions = [
        ...
        create_dungeon_region('SH Blocks On Ice', ['Compass Chest', 'SH SF8', 'SH SF9'], ['SH Entrance Room', 'SH 2 Stack Push Room', 'SH Icicles Room']),
        create_dungeon_region('SH Icicles Room', ['Small Key Chest', 'SH SF10'], ['SH Blocks On Ice', 'SH Pound Puzzle Room']),
        create_dungeon_region('SH Pound Puzzle Room', ['SH SF11'], ['SH Icicles Room', 'SH Central Tower']),
        ...
        create_ow_region('Path to Goron Village', ['Lake HP Chest'], ['Mountain Village', 'Outside Goron Village']),
        create_ow_region('Outside Goron Village', ['Powder Keg Test'], ['Path to Goron Village', 'Lens of Truth Cave', 'Goron Village']),
        create_interior_region('Lens of Truth Cave', ['Invisible Chest'], ['Outside Goron Village']),
        create_interior_region('Goron Village', [], ['Outside Goron Village']),
        create_interior_region('Goron Shrine', [], ['Mountain Village']),
        create_ow_region('Path to Snowhead', ['Scarecrow HP'], ['Mountain Village', 'Snowhead']),
        create_ow_region('Snowhead', [], ['Path to Snowhead', 'Snowhead Fairy Shrine', 'SH Entrance Room']),
        create_interior_region('Snowhead Fairy Shrine', ['Snowhead GF Reward'], ['Snowhead Spire']),

        create_ow_region('Great Bay Coast', ['Zora Mask', 'Cliff HP', 'Island Jumping Game'], ['Fisherman Hut', 'Oceanside Spider House', 
                          'Marine Research Lab', 'Pirate Fortress', 'Pinnacle Rock', 'Zora Cape']),
        create_interior_region('Fisherman Hut', ['Seahorse'], ['Great Bay Coast']),
        create_interior_region('Oceanside Spider House', ['Mask Code Chest', 'Bunker Buyout'], ['Great Bay Coast']),
        create_interior_region('Marine Research Lab', ['Fish Food', 'NWBN Check'], ['Great Bay Coast']),
        create_ow_region('Pirate Fortress', ['Underwater Maze Chest', 'Jailbreak', 'Hookshot Chest', '100 Rupee Chest'], ['Great Bay Coast']),
        create_interior_region('Pinnacle Rock', ['Reunited'], ['Great Bay Coast']),
        create_ow_region('Zora Cape', ['Bottom Of The Basin', 'Cliff Chest'], ['Great Bay Coast', 'Zora Hall', 'Waterfall Rapids', 
                                'Great Bay Fairy Shrine', 'GB Entrance Room']),
        create_interior_region('Zora Hall', ['Stage Lighting'], ['Zora Shop', 'Zora Hall Drummer Room', 'Zora Hall Lulu Room', 'Zora Hall Bassist Room', 
                               'Zora Hall Pianist Room']),                                  
        create_interior_region('Zora Shop', [], ['Zora Hall']),
        create_interior_region('Zora Hall Drummer Room', [], ['Zora Hall']),
        create_interior_region('Zora Hall Lulu Room', ['Mountain Title Deed HP'], ['Zora Hall']),
        create_interior_region('Zora Hall Bassist Room', [], ['Zora Hall']),
        create_interior_region('Zora Hall Pianist Room', ['Plagiarism'], ['Zora Hall']),
        ...
        create_dungeon_region('GB Entrance Room', ['GB SF1'], ['GB Exit To Zora Cape', 'GB First Room', 'GB Boss Warp']),
        create_dungeon_region
        
        create_ow_region('Path to Ikana', ['Invisible Man', 'Way Of The Garo'], ['TF', 'Ikana Graveyard', 'Ikana Canyon']),
        create_ow_region('Ikana Graveyard', ['Captains Chest'],
            ['SoS Grave Grotto', 'HP Grave Grotto', 'Dampe Grave Grotto', 'Dampe Door']),
        create_interior_region('Dampe Grave', ['Big Poe Chest'], ['Dampe Door']),
        create_grotto_region('Storms Grave', ['Keese Chest', 'Song Of Storms'], ['Ikana Graveyard']),
        create_grotto_region('Heart Piece Grave', ['Iron Knuckle Chest'], ['Ikana Graveyard']),
        create_interior_region('Sakon Hideout', ['Sun Mask']), #technically lacks exits?
        create_interior_region('Secret Shrine', ['4 Trials Chest'], ['Ikana Canyon']),
        create_interior_region('Poe Sister House', ['Ghostbusters'], ['Ikana Canyon']),
        create_interior_region('Spoop Cave', ['Make It Rain'], ['Ikana Canyon']),
        create_interior_region('Music Box House', ['Break The Curse'], ['Ikana Canyon']),
        create_interior_region('Bottom of the Well', ['Purple Rupee Chest', '4 Torches Chest'], ['Ikana Canyon', 'Ikana Castle']
        create_ow_region('Ikana Castle'),
        create_ow_region('Stone Tower', [], ['Ikana Canyon', 'ST Entrance Room', 'Stone Tower (Inverted)']),
        create_ow_region('Stone Tower (Inverted)', [], ['Stone Tower', 'ST Entrance Room (Inverted)']),                       
